...
define('G5_MYSQL_USER', 'iksrok');
define('G5_MYSQL_PASSWORD', 'yoonjulie1*');
define('G5_MYSQL_DB', 'iksrok');
define('G5_MASTER_PW', '');
define('G5_DB_URL', 'iksrok.dothome.co.kr/myadmin');
...
$g5['quest_table'] = G5_TABLE_PREFIX.'quest'; // 퀘스트 테이블
?>